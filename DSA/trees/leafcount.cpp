...
class tree{
    ...
    int deg1ordeg2count(node* p);
    int deg1ordeg2count(){return deg1ordeg2count(root);}
    int deg1count(node* p);
    int deg1count(){return deg1count(root);}
...
int tree::deg1ordeg2count(node* p){
    int x, y;
    if(p){
        x=deg1ordeg2count(p->lchild);
        y=deg1ordeg2count(p->rchild);
        if(!p->lchild || !p->rchild){
            return x+y+1;
        }
        else{
...
int main(){
    ...
    cout<<"no. of leaf nodes: "<<bt.leafcount(t)<<endl;
    cout<<"no. of degree 1 or degree 2 nodes: "<<bt.deg1ordeg2count(t)<<endl;
    cout<<"no. of degree 1 nodes: "<<bt.deg1count(t)<<endl;
